...
7. `.windsurf/templates/Dependency-template.md` — format for new system's Dependency.md
...
Follow ALL [C# Conventions](../rules/csharp-conventions.md) and GOAL.md rules. Load domain skills when relevant:
