...
7. `.claude/templates/Dependency-template.md` — format for new system's Dependency.md
...
Follow ALL [C# Conventions](.claude/instructions/csharp-conventions.md) and GOAL.md rules. Load domain skills when relevant:
- **[unity-testing](.claude/skills/unity-testing.md)** — when generating Test.md, DEBUG_Check, or Manual/*.md
- **[unity-scene-setup](.claude/skills/unity-scene-setup.md)** — when documenting scene setup or Dependency.md Scene Setup section
- **[unity-audio](.claude/skills/unity-audio.md)** — when the system involves sound playback
- **[unity-animation](.claude/skills/unity-animation.md)** — when the system involves animation or motion
- **[unity-prefab-hierarchy](.claude/skills/unity-prefab-hierarchy.md)** — when the system involves prefab GO structure, collider zones, or connection points
- **[unity-save-load](.claude/skills/unity-save-load.md)** — when adding a system with persistence, ISaveable, save data classes
- **[unity-fsm](.claude/skills/unity-fsm.md)** — when adding a system with state machines, IState implementations
- **[unity-day-night](.claude/skills/unity-day-night.md)** — when adding time/day-night cycle, IDaytimeSensitive hooks
- **[unity-ai-navigation](.claude/skills/unity-ai-navigation.md)** — when adding NPC pathfinding, NavMesh agents, patrol behaviors
- **[unity-networking](.claude/skills/unity-networking.md)** — when adding networked systems, RPCs, state sync
- **[unity-quest](.claude/skills/unity-quest.md)** — when adding quest/objective tracking systems
- **[unity-procedural-gen](.claude/skills/unity-procedural-gen.md)** — when adding procedural generation, chunk systems
- **[unity-camera](.claude/skills/unity-camera.md)** — when adding camera systems, Cinemachine VCams
- **[unity-dialogue](.claude/skills/unity-dialogue.md)** — when adding dialogue/conversation systems, NPC speech
- **[unity-input](.claude/skills/unity-input.md)** — when adding input systems, rebinding, action maps
- **[unity-physics](.claude/skills/unity-physics.md)** — when adding physics-based systems, joints, ragdoll, grab mechanics
- **[unity-inventory](.claude/skills/unity-inventory.md)** — when adding inventory, equipment, hotbar, item containers
- **[unity-grid-building](.claude/skills/unity-grid-building.md)** — when adding building/placement systems, grid snapping, ghost preview
