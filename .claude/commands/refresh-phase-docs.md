...
2. Read `.claude/templates/Dependency-template.md` — exact structure to follow for each system
3. Read `.claude/templates/GUIDE-template.md` — exact structure for GUIDE.md
4. Read `.claude/templates/FLOW-template.md` — exact structure for FLOW.md
