# .github/ Framework — ROADMAP & Benchmark

> **What is this file?** A living document tracking the maturity, gaps, and future plans for the `.github/` automation framework. It tells you what the framework handles well, what it can't do yet, and what's planned.
>
...
1. Add the rule to `.github/templates/GOAL-general.md` using generic placeholders (`[SystemName]`, `[PHASE_X]`)
2. Add any new common mistakes to `.github/templates/NewAgent-general.md`
3. Update `.github/copilot-instructions.md` conventions summary if the rule is fundamental
