...
14. Write `.github/WORKSPACE-REG.md` with this exact structure:
...
16. Update `.github/copilot-instructions.md` if project count changed (update workspace description if different)
