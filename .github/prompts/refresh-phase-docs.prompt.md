...
2. Read `.github/templates/Dependency-template.md` — exact structure to follow for each system
3. Read `.github/templates/GUIDE-template.md` — exact structure for GUIDE.md
4. Read `.github/templates/FLOW-template.md` — exact structure for FLOW.md
