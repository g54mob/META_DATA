...
4b. Read ALL templates in `.github/templates/` — these define the exact structure for every generated doc:
...
9. Create `LEARN/{PROJECT}/ARCHITECTURE.md` — follow `.github/templates/ARCHITECTURE-template.md`. Use this **mandatory Table of Contents**:
...
13. Create `LEARN/{PROJECT}/PhaseMap.md` — follow the structure in `.github/templates/PhaseMap-template.md`
...
15. Create `LEARN/{PROJECT}/StructureMap.md` — follow the structure in `.github/templates/StructureMap-template.md`

## Generate GOAL.md (from template)

16. **Read `.github/templates/GOAL-general.md`** — this is the universal architecture rules template containing ALL conventions: folder structure, naming, class responsibilities, decoupling, lifecycle, C# features, testing, pitfalls, gold-standard doc examples, mandatory patterns, common agent mistakes.
...
19. **Read `.github/templates/NewAgent-general.md`** — this is the universal agent instruction template containing: first prompt, delivery checklist, common mistakes, mandatory patterns, reference files table.
...
22. Create `LEARN/{PROJECT}/Estimate.md` — follow `.github/templates/Estimate-template.md`. Hours per phase using these complexity tiers:
...
23. Create `LEARN/{PROJECT}/SystemPortabilityMap.md` — follow `.github/templates/SystemPortabilityMap-template.md`. For every system in every phase:
...
24. Create `LEARN/{PROJECT}/CoverageMap.md` — follow `.github/templates/CoverageMap-template.md`. Cross-reference table:
...
25. Create `LEARN/{PROJECT}/OptionalFeatures.md` — follow `.github/templates/OptionalFeatures-template.md`. Features outside mandatory 100% scope:
...
25b. Create `LEARN/{PROJECT}/GameStateSoFar.md` — follow `.github/templates/GameStateSoFar-template.md`. This is the plain-English progressive gameplay state guide:
...
26b. Create `LEARN/{PROJECT}/SystemIsolationAnalysis.md` — follow `.github/templates/SystemIsolationAnalysis-template.md`. The global architectural isolation map:
...
27. Create `LEARN/{PROJECT}/surfer.md` — follow `.github/templates/surfer-template.md`. Format:
