...
> **Output:** A comprehensive gap report with prioritized TODO items. Save to `.github/audit-required-todo.md`
...
### 3. Read the current .github/ framework

Read ALL existing framework files (skills, conventions, templates, prompts):
- `.github/skills/*/SKILL.md` — read FULL bodies, note what they cover and what they assume
- `.github/instructions/csharp-conventions.instructions.md` — note all rules
- `.github/templates/*.md` — note all fields/sections
- `.github/prompts/*.prompt.md` — note all steps and skill references
...
Save the full report as `.github/audit-required-todo.md` with this structure:
...
- "Save this as `.github/audit-required-todo.md`?"
